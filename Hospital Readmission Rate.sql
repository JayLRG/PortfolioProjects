--1: Average billing amount per insurance_provider, grouped by medical_condition
--2: Most common admission_type per medical condition
--3: 30-day readmission rate; Discharge_date -> next Date_of_admission being < 30 days apart


--1: Average billing amount per insurance_provider
...
--2: Number of Admissions by condition and admission type
...
--4: Readmissions by medical condition
...
--Creating tables to produce queries 3 and 4;
